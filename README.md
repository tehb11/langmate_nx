...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/feNjZZS4tT)
...
```sh
npx nx serve langmate
```

To create a production bundle:

```sh
npx nx build langmate
```

To see all available targets to run for a project, run:

```sh
npx nx show project langmate
```
